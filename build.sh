...
echo "branch: $BRANCH" >> $WORK_PATH/output/ad_version
echo "commit: $COMMIT" >> $WORK_PATH/output/ad_version
echo "gcc_version: $GCC_VERSION" >> $WORK_PATH/output/ad_version
echo "compile_time: $COMPILE_TIME" >> $WORK_PATH/output/ad_version
